...
<div class="navbar">
    <div class="navbar-header">
        <div class="navbar-brand"><img style="top: -10px; left: -11px; width: 99%;" src="<%=request.getContextPath()%>/resources/CustomHomeTheme/frame1/res/images/hrms_logo.png" /> </div>
        <div class="navbar-brand navbar-brand-compact"> <img style="position:absolute;clip:rect(0px 43px 50px 0px);  width:280px;height:40px;" src="<%=request.getContextPath()%>/resources/CustomHomeTheme/frame1/res/images/hrms_logo.png" /> </div>
    </div>
