...
<div class="mini-fit">
    <div id="salaryDatagrid" class="mini-datagrid"  allowAlternating="true" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div field="post" width="80" allowSort="false" align="center" headerAlign="center">岗位</div>
            <div field="postSalary" width="80" allowSort="false" align="center" headerAlign="center">岗位工资</div>
            <div field="yearSalary" width="80" allowSort="true" align="center" headerAlign="center">工龄工资</div>
            <div field="floatSalary" width="80" allowSort="true" align="center" headerAlign="center">浮动工资</div>
            <div field="award" width="80" allowSort="true" align="center" headerAlign="center">绩效奖金</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        mini.get("startDate").setValue(today);
        mini.get("endDate").setValue(today);
        $.ajax({
...
*/
        ...
        var date2=new Date(mini.get("endDate").getValue());
        if(date1>date2){
            alert("开始时间必须小于结束时间！");
            return;
        }
        grid.load({ 'dah': dah,'startDate': startDate,'endDate': endDate });
    }

    // 导出报表
    function print() {
        $.ajax({
            url: "<%=request.getContextPath()%>/ajax/printStament.do",
            data:"",
            type: "post",
            dataType: 'text',
