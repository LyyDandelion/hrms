...
<div id="userDiv" style="height:100%;border:0px solid #e0e0e0;">
    <div style="height:26px;width:100%;text-indent:5px;font-weight:bold;font-family:Simsun;font-size:14px;line-height:26px;">结算信息
    </div>
    <form id="userForm">
            ...
            <tr>
                ...
                <td>
                    <input id="dah" name="dah" class="mini-combobox" textField="dah" valueField="dah"
                           ...
                           onvaluechanged="levelChange" value="${settlement.dah}"/>
                </td>
            </tr>
            <tr>
                <td style="text-align:right;">月份：</td>
                <td>
                    <input id="month" name="month" class="mini-textbox" style="width:250px;" required="true" value="${settlement.month}"/>
                </td>
            </tr>

            <tr>
                <td style="text-align:right;">实发工资：</td>
                <td>
                    <input id="realWages" name="realWages" class="mini-textbox" style="width:250px;" required="true" value="${settlement.realWages}"/>
                </td>
            </tr>
            <tr>
                <td>
...
<script type="text/javascript">
    ...
    function levelChange(){
        ...
        $.ajax({
            url:"ajax/settlement_checkIsExsit.do",
            data:{
                dah:dah
            },
    ...
    function save() {
        ...
        if (form.isValid() == true) {
            if (paramAction == "add") {
                mini.confirm("是否确定更新该员工工资数据？", "确定？",function(action) {
                    if (action == "ok") {
                        $.ajax({
