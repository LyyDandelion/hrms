...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="userBody" style="display: none">
        <div class="mini-toolbar" style="padding:2px;border-bottom:0;">
            <table style="width:100%;table-layout:fixed;">
                <tr>
                    ...
                    <td style="width:120px">
                        <a class="mini-button" style="width:120px" iconCls="icon-add" id="add" onclick="add()">创建岗位</a>
                    </td>
        ...
        <div class="mini-fit">  
            ...
            url="<%=request.getContextPath()%>/ajax/position_getPositions.do" allowResize="true" idField="dah" pageSize="50">
        ...
        <script type="text/javascript">
           ...
           /* $(document).ready(function() {
            ...
            function add() {
                mini.open({
                    url: "<%=request.getContextPath()%>/showPositionUpdPop.do",
                    title: "岗位创建", width: 800, height: 500,
                    onload: function () {
            ...
            function editRow(row_uid) {
                ...
                if (row) {
                    mini.open({
                        url: "<%=request.getContextPath()%>/showPositionUpdPop.do",
                        title: "编辑岗位信息", width: 800, height: 640,
                        onload: function () {
                            var iframe = this.getIFrameEl();
